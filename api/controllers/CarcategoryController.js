...
const schema = {
    "type": "object",
    "required": ['carCategoryName', "carCategorySlug"],
    "properties": {
        carCategoryName: {
            type: "string", minLength: 1,

            errorMessage: {
                type: 'CAR_CATEGORY_NAME_MUST_BE_STRING',
                minLength: 'CAR_CATEGORY_NAME_IS_REQUIRED',
            },
        },
        carCategorySlug: {
            type: "string",
            errorMessage: {
                type: 'CAR_CATEGORY_SLUG_MUST_BE_STRING',
            },
        }
    },
    errorMessage: {
        ...
        required: {
            carCategoryName: 'should have an string property carCategoryName',
            carCategorySlug: 'should have a string property carCategorySlug',
        }
    },
